...
public class Week4Assignment {
	...
	public static void main(String[] args) {
		// 1. Why would we use a StringBuilder instead of a String? A String can not be changed it is immutable, a StringBuilder
				// can be changed, it is a mutable object . If going to be built up or changed a StringBuilder makes sense.
				...
				List<List<Integer>> sortedNumbers = sortDivisibleNumber(numbers);
				...
				dictionary.put("Orange", " A sweet orange fruit");
				dictionary.put("Grape", " A fruit that is often squezzed");
				dictionary.put("Hammock", " A place to hang out");
				...
				String value = lookupValue(dictionary, "Hammock");
	 ...
	 public static List<Integer> calculateStringLengths(List<String> list) {
			...
			// Method 7:
	 public static List<List<Integer>> sortDivisibleNumber(List<Integer> list) {
